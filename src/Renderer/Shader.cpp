...
void lwvl::Uniform::set3u(const unsigned int v0, const unsigned int v1, const unsigned int v2) { glUniform3ui(m_location, v0, v1, v2); }

void lwvl::Uniform::set4i(const int v0, const int v1, const int v2, const int v3) { glUniform4i(m_location, v0, v1, v2, v3); }
void lwvl::Uniform::set4f(const float v0, const float v1, const float v2, const float v3) { glUniform4f(m_location, v0, v1, v2, v3); }
void lwvl::Uniform::set4u(const unsigned int v0, const unsigned int v1, const unsigned int v2, const unsigned int v3) { glUniform4ui(m_location, v0, v1, v2, v3); }
